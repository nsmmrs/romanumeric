...
- Create a tag with the version found in `romanum.opam`, and push it to your repository.
...
The following snippet describes romanum's repository structure.
...
│
├── bin/
|   Source for romanum's binary. This links to the library defined in `lib/`.
│
├── lib/
|   Source for romanum's library. Contains romanum's core functionnalities.
│
├── test/
|   Unit tests and integration tests for romanum.
│
├── dune-project
